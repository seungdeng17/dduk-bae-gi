...
public class CHardBossMonsterState : CMonsterState
{
    protected CHardBossMonsterManager _hardBossMonsterManager; // 하드 보스 몬스터 목록 관리 매니저
    protected CHardStageManager _hardStageManager;
    ...
    public Transform _hardBossParent;
    ...
    protected override void OnSpawned()
    {
        ...
        if (_hpBar == null)  // 스폰 되면서 변경해야 할 정보는 스폰 할 때 캐싱해야 됨
        {
            ...
            _hardBossMonsterManager = GameObject.FindGameObjectWithTag("HardBossMonsterManager").GetComponent<CHardBossMonsterManager>();
            _hardStageManager = GameObject.FindGameObjectWithTag("HardStageManager").GetComponent<CHardStageManager>();
        }
        ...
        // 스테이지에 맞게 스텟 세팅
        _hardStageManager.HardStageBalanceMonster(this, _hardStageManager._hardStage - 1f);
        ...
        _hardStageManager.HardStageTextRefresh();
    }
    ...
    public override ObscuredFloat HpDown(ObscuredFloat damage)
    {
        ...
        if (_hpBar.ValueF <= 0f)
        {
            ...
            _hardStageManager.HardStageClear();
        }
        return _hp;
    }


    protected override void MonsterDieEvent()
    {
        _hardBossParent.parent = _backGroundTr;
    ...
    protected override IEnumerator DespawnMonsterCoroutine()
    {
        yield return _monsterDespawnWaitTime;

        // 디스폰
        Pooly.Despawn(_hardBossParent);
    }
    ...
    protected override void OnMonsterDespawn()
    {
        ...
        _hardBossMonsterManager._hardBossMonsterNum = 0;
    }
